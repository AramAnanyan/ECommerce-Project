...
internal sealed class AddCustomerCouponAccessCommandHandler : IRequestHandler<AddCustomerCouponAccessCommand>
{
    private readonly ICouponRepository _couponRepository;
    private readonly IUnitOfWork _unitOfWork;
    public AddCustomerCouponAccessCommandHandler(ICouponRepository couponRepository, IUnitOfWork unitOfWork)
    {
